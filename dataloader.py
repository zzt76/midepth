    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'train':
            ...
            if self.args.dataset == 'nyu':
                ...
                depth_gt = tf.to_pil_image(tf.invert(tf.to_tensor(tf.to_grayscale(depth_gt))))
            ...
            if self.args.dataset == 'kitti':
                image_path = os.path.join(self.args.data_path_eval, remove_leading_slash(sample_path.split()[0]))
                depth_path = os.path.join(self.args.gt_path_eval, remove_leading_slash(sample_path.split()[1]))
            elif self.args.dataset == 'nyu':
                image_path = os.path.join(self.args.data_path_eval, remove_leading_slash(sample_path.split()[0]))
                depth_path = os.path.join(self.args.gt_path_eval, remove_leading_slash(sample_path.split()[1]))
            elif self.args.dataset == 'mi':
